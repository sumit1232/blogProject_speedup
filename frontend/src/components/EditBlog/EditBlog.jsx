...
const EditBlog = () => {
    ...
    const UpdateForm = async (e) => {
        e.preventDefault()
        console.log(data)
        alert('Sucessfully Updated Form.')

        await axios.put(`http://localhost:3000/blogdetails/${res.id}`, data)
  ...
  <div className="bg-gray-50 min-h-screen pt-8">
        ...
        <section className="max-w-2xl mx-auto mb-12 px-4">
          ...
          >
            <h2 className="text-2xl font-bold mb-6 text-gray-800">Update a Blog Post</h2>
            <div className="mb-4">
